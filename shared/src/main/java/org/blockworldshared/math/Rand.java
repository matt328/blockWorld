...
public final class Rand {
	 ...
	 * 
	 * @param mean
	 *            The mean of the poisson distrubution to sample from
	 * @return
	 */
	 ...
	 * 
	 * Discrete distribution with decay rate p Mean = (1-p) / p Probability mass function for each integer output k = p.(1-p)^k
	 */
