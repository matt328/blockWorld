 ...
 */
package org.blockworld.math.functions.loader;
...
import org.blockworld.math.functions.loader.Functions.Function;
import org.blockworld.math.functions.loader.Functions.Function.FloatComponent;
import org.blockworld.math.functions.loader.Functions.Function.FunctionComponent;
import org.blockworld.math.functions.loader.Functions.Function.IntComponent;
import org.blockworld.math.functions.loader.Functions.Function.StringComponent;
...
public class FunctionData {
   ...
   private final Map<String, org.blockworld.math.functions.Function> functionMap;
   ...
   public FunctionData(final String filename) throws Exception {
      ...
      functions = (Functions) um.unmarshal(new File(filename));
      ...
      for (final Function functionData : functions.getFunction()) {
         ...
         final org.blockworld.math.functions.Function f = (org.blockworld.math.functions.Function) Class.forName(typeName).newInstance();
      ...
      for (final Function functionData : functions.getFunction()) {
         final org.blockworld.math.functions.Function f = functionMap.get(functionData.getId());
   ...
   public void setIntParameter(final String path, final int value) throws FunctionException {
      ...
      final org.blockworld.math.functions.Function theFunction = getFunctionById(functionId);
   ...
   public org.blockworld.math.functions.Function getFunctionById(final String functionId) throws FunctionException {
      final org.blockworld.math.functions.Function f = functionMap.get(functionId);
      if (f != null) {
         return f;
      }
   ...
   private int getFunctionIntField(final org.blockworld.math.functions.Function theFunction, final String fieldName) throws FunctionException {
      int value;
      try {
   ...
   private void setFunctionIntField(final org.blockworld.math.functions.Function theFunction, final String fieldName, final int value) throws FunctionException {
