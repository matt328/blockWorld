...
public interface TextureAtlas {
   ...
   /**
    * Return the texture coordinates for a block type and a face (left, right,
    ...
    * @param blockType
    *           must not be <code>null</code>
    * @return <code>true</code> if the block type represents a transparent
    *         material else <code>false</code>
    */
   boolean isTransparent(Integer blockType);

   /**
    * Gets a debug {@link Material} with plain red color.
    * 
    * @return a debug {@link Material} with red color.
    */
   Material getRedMaterial();

   /**
    * Gets a debug {@link Material} with a plain blue color.
    *
    * @return a debug {@link Material} with plain blue color.
    */
