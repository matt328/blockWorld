...
public class PagingStats {
	...
	public void getData(String[] statData) {
		...
		statData[2] = Integer.toString(world.getChunksToFillSize());
		statData[3] = Integer.toString(world.getChunksToCalculateSize());
		statData[4] = Integer.toString(world.getChunksToAddSize());
	}
